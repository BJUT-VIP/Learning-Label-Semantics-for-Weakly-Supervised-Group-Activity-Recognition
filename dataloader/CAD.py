...
class CollectiveDataset(data.Dataset):
    ...
    def __init__(self, frames, anns, images_path, image_size, num_boxes=13, num_frames=10,
    ...
    def get_frames(self, frame):
        ...
        if self.is_finetune:
            ...
            if self.is_training:
                ...
                sample_frames = [src_fid, src_fid + 3, src_fid + 6, src_fid + 1, src_fid + 4, src_fid + 7, src_fid + 2,
                                 src_fid + 5, src_fid + 8]
                return [(sid, src_fid, fid) for fid in sample_frames]
    ...
    def load_samples_sequence(self, select_frames):
        ...
        for i, (sid, src_fid, fid) in enumerate(select_frames):
            ...
            img = transforms.functional.resize(img, (720, 1280))
            img = np.array(img)
        ...
        return bboxes, images, activities