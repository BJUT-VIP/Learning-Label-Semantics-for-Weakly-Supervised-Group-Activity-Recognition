...
class NBADataset(data.Dataset):
    ...
    def load_samples(self, frames):
        ...
        label_od = np.array(label_od, dtype=np.int32)
        ...
        label_od = torch.from_numpy(label_od).long()


        return ls, images, activities, labels, label0, label1, label2, label_od
